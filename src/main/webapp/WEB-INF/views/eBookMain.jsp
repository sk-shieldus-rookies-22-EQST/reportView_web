    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/images/common_img/test_ignited.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="/images/common_img/test_happiness.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="/images/common_img/test_think.png" class="d-block w-100" alt="...">
        </div>
      </div>
                    ...
                    <c:forEach var="book" items="${books}">
                        <div style="cursor:pointer;display: flex;align-items: center;flex-direction: column;margin-bottom: 5%;justify-content: flex-end;">
                            ...
                            <div style="margin: 0% 10%;width:184px;"  onclick="location.href='/eBookDetail?book_id=${book['book_id']}'">
                                <img class="image_container" src="/images/book_img/test.jpg" style="border:1px solid; position: relative;width: 100%;overflow: hidden;">
