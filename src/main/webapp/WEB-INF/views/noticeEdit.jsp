...
<div class="container" style="margin-bottom: 30px;">
	...
	<div class="container" style="max-width: 1200px;margin-bottom:100px;border-radius: 5px;padding: 50px 20px;">
		<p class="text-start fs-1 fw-bold" style="display: flex;justify-content: center; margin-bottom:30px;margin-top:16px">공지사항</p>
            ...
            <form method="post" action="noticeUpdateProcess" enctype="multipart/form-data">
            <input type="hidden" name="notice_id" value="${noticeDetail.notice_id}">
                    ...
                    <tbody>
                        <tr><td>
                            <div class="input-group">
                                  <input type="text" class="form-control" value="${noticeDetail.notice_title}" name="notice_title" maxlength="30" >
                            </div>
                            </td>
                        </tr>
                        <tr>
                            <td><textarea style="resize:none; width: 100%; height: 400px; border: none;" class="form-control" name="notice_body" maxlength="2048" >${noticeDetail.notice_body}</textarea></td>
                        </tr>
                        <tr>
                ...
                <div style="float:right;">
                    <a href="/noticeDetail?notice_id=${noticeDetail.notice_id}" class="btn btn-secondary pull-right">취소</a>
