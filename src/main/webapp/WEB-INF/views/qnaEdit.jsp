		...
		<p class="text-start fs-1 fw-bold" style="display: flex;justify-content: center; margin-bottom:30px;margin-top:16px">QNA 게시판</p>
            ...
            <input type="hidden" name="qna_id" value="${qnaDetail.qna_id}">
                <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
                    ...
                    <tbody>
                        <tr>
                            <td><input type="text" class="form-control" placeholder="${qnaDetail.qna_title}" name="qna_title" maxlength="50"></td>
                        </tr>
                        <tf>
                            <td><textarea class="form-control" placeholder="${qnaDetail.qna_body}" name="qna_body" maxlength="2048" style="height: 350px;"></textarea></td>
                        </tr>
                        <tr>
